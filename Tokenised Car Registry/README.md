...
```
{
    ...
    "flowClassName": "com.r3.developers.samples.TokenisedCarRegistry.workflows.IssueGoldTokensFlow",
    "requestBody": {
        "symbol": "GOLD",
...
```
{
    ...
    "flowClassName": "com.r3.developers.samples.TokenisedCarRegistry.workflows.ListGoldTokens",
    "requestBody": {}
}
```
...
```
{
    ...
    "flowClassName": "com.r3.developers.samples.TokenisedCarRegistry.workflows.BurnGoldTokenFlow",
    "requestBody": {
        "symbol": "GOLD",
        "issuer": "CN=Alice, OU=Test Dept, O=R3, L=London, C=GB",
        "amount": "5"
