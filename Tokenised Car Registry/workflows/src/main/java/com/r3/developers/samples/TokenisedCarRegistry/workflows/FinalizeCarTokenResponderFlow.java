...
@InitiatedBy(protocol = "finalize-car-protocol")
public class FinalizeCarTokenResponderFlow implements ResponderFlow {
    private final static Logger log = LoggerFactory.getLogger(FinalizeCarTokenResponderFlow.class);
    ...
    public void call(FlowSession session) {
        ...
        try {
            ...
            UtxoTransactionValidator txValidator = ledgerTransaction -> {
                //CarState state = (CarState) ledgerTransaction.getOutputContractStates().get(0);
