...
public class FinalizeCarSubFlow implements SubFlow<String> {

    private final static Logger log = LoggerFactory.getLogger(FinalizeCarSubFlow.class);
    private final UtxoSignedTransaction signedTransaction;
    private final MemberX500Name otherMember;

    public FinalizeCarSubFlow(UtxoSignedTransaction signedTransaction, MemberX500Name otherMember) {
