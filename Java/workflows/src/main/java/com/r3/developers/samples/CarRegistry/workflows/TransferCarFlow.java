...
public class TransferCarFlow implements ClientStartableFlow {

    private final static Logger log = LoggerFactory.getLogger(TransferCarFlow.class);
    ...
    public String call( ClientRequestBody requestBody) {
        try{
            ...
            return flowEngine.subFlow(new FinalizeCarSubFlow(signedTransaction, owner.getName()));
...
/*
{
    ...
    "flowClassName": "com.r3.developers.samples.CarRegistry.workflows.TransferCarTokenFlow",
    "requestBody": {
"consumed": "False",
"mileage" : "11000",
"lscTire": "20231104",
