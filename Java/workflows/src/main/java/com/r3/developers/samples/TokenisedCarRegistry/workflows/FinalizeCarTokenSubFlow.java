...
public class FinalizeCarTokenSubFlow implements SubFlow<String> {

    private final static Logger log = LoggerFactory.getLogger(FinalizeCarTokenSubFlow.class);
    private final UtxoSignedTransaction signedTransaction;
    private final MemberX500Name otherMember;

    public FinalizeCarTokenSubFlow(UtxoSignedTransaction signedTransaction, MemberX500Name otherMember) {
